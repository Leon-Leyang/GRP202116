...
<template>
  <div class="page-block">
      ...
      <div class="manage-header">
          <!-- <el-button type="primary" @click="addProject" icon="el-icon-plus" circle ></el-button> -->
      </div>
      <Table :tableData="tableData" :config="config" @changePage="getList()" @edit="editProject" @del="delProject" @add="addProject"/>
  </div>
